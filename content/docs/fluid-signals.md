...
which powers [Observable](https://observablehq.com/framework/). `fluid.cell` passes all the [test cases](https://github.com/solidjs/signals/blob/main/tests/createAsync.test.ts)
currently issued for Solid signals' `createAsync`.
